...
2.  **Shot List**:
    - **Shot 1 (Wide)**: Establishing the empty kitchen. Steam rises from the baskets.
    - **Shot 2 (Medium)**: Pan right to reveal the steamer basket.
    - **Shot 3 (Close-up)**: Inside the basket, Momo opens his eyes.
