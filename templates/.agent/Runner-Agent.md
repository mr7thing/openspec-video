...
opsv run opsv-queue/videospec_circle2/volcengine.seedance/
# 也可一次执行多个路径
opsv run opsv-queue/videospec_circle1/volcengine.seadream_001/ opsv-queue/videospec_circle2/volcengine.seedance/
```
