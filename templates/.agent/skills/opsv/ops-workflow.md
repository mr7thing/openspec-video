...
> 当前版本：v0.8.27 (深层目录扫描 + 同名 assetId 检测)
...
# 产出: opsv-queue/videospec_circle1/volcengine.seadream_001/shot_01.json 等
...
# 产出: opsv-queue/videospec_circle2/volcengine.seedance_001/shot_01.json 等
...
# 执行多个路径
opsv run opsv-queue/videospec_circle1/volcengine.seadream_001/shot_01.json opsv-queue/videospec_circle1/volcengine.seadream_001/shot_02.json
...
opsv run opsv-queue/videospec_circle1/volcengine.seadream_001/@hero_3.json
# → 生成 @hero_3_1.png
...
```bash
# 导演修改了 scenes/classroom.md，新增 refs: { image: { "@blackboard": [path] } }
