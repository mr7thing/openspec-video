...
# 产出: opsv-queue/videospec.circle1/volcengine.seadream/shot_01.json 等
...
# 产出: opsv-queue/videospec.circle2/volcengine.seedance/shot_01.json 等
...
# 执行多个路径
opsv run opsv-queue/videospec.circle1/volcengine.seadream/shot_01.json opsv-queue/videospec.circle1/volcengine.seadream/shot_02.json
...
# 再次修改
cp opsv-queue/videospec.circle1/volcengine.seadream/@hero_2.json \
   opsv-queue/videospec.circle1/volcengine.seadream/@hero_3.json
# 编辑 @hero_3.json
opsv run opsv-queue/videospec.circle1/volcengine.seadream/@hero_3.json
# → 生成 @hero_3_1.png
