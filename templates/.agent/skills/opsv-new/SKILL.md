...
### 3. New Asset (Character/Prop/Scene)
- **Action**: Create a new Markdown file in the drafting sandbox: `artifacts/elements/` for characters/props, or `artifacts/scenes/` for locations. DO NOT draft directly to `videospec/`.
- **Template**:
  ```markdown
  ---
  id: "unique_id"
