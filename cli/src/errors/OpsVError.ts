...
export enum OpsVErrorCode {
  ...
  CAPABILITY_CONTRACT_INVALID = 'E3004',
  CAPABILITY_UNKNOWN = 'E3005',
  ...
  EXECUTION_IDEMPOTENCY_CONFLICT = 'E4011',
  EXECUTION_SEQ_UNRECOVERABLE = 'E4012',
  EXECUTION_ALREADY_INITIALIZED = 'E4013',
  EXECUTION_NOT_FOUND = 'E4014',
  EXECUTION_PLAN_REVISION_UNRESOLVED = 'E4015',
  EXECUTION_INVALID_TRANSITION = 'E4016',

  // E5xxx — Infrastructure: file not found, network, WebSocket
  INFRA_FILE_NOT_FOUND = 'E5001',
  INFRA_NETWORK_ERROR = 'E5002',
  INFRA_PATH_FORBIDDEN = 'E5003',
  INFRA_LOCK_TIMEOUT = 'E5004',
